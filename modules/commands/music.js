...
api.sendTypingIndicator(event.threadID, true);
  ...
  if (data.length < 2) {
    return api.sendMessage("[ ! ] Input music title.", event.threadID, event.messageID);
  }
  ...
  try {
    api.sendMessage(`🔎 Searching music for ${prompt}! Please wait...`, event.threadID, event.messageID);
