module.exports = function({ api }) {
  ...
  global.loading(`${cra(`[ BOT_INFO ]`)} a sample botpack for starting a facebook messenger chat bot modified by : bundas andrian!\n${co(`[ NAME ]:`)} ${(!global.config.BOTNAME) ? "xyz" : global.config.BOTNAME} \n${co(`[ UID ]:`)} ${api.getCurrentUserID()} \n${co(`[ PREFIX ]:`)} ${global.config.PREFIX}`, "LOADED");
