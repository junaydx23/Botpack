...
module.exports.run = async ({ api, event, args, Threads }) => {
  ...
  ctx.textAlign = "start";
  ctx.font = "55px time";
  ctx.fillText(`${global.config.BOTOWNER}`, 930, 540)
  ctx.fillText(`${global.config.BOTOWNER}`, 930, 610)
  ctx.fillText(`${global.config.BOTOWNER}`, 930, 690)
  ctx.restore();
  ctx.save();
  ctx.beginPath();
