...
module.exports.run = async function({ api, event, args }) {
  ...
  var text = args.join(" ");
  if (!text) return api.sendMessage("[ ! ] Type a message...", threadID, messageID);
  ...
  return api.sendMessage({ attachment: fs.createReadStream(pathImg) }, threadID, () => fs.unlinkSync(pathImg));
  };