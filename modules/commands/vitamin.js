module.exports.config = {
  ...
  hasPermission: 0,
  credits: "tq.info",
  description: "randomly vietnamese female video.",
...
module.exports.run = async ({ api, event, args }) => {
  ...
  api.sendMessage({ body: `Downloaded Successfull(y).`, attachment: fs.createReadStream(__dirname + "/cache/vitamin/vitamin.mp4") }, threadID, () => fs.unlinkSync(__dirname + "/cache/vitamin/vitamin.mp4"));
    }, 5000);
  return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname + "/cache/vitamin/vitamin.mp4")).on("close", () => callback());
  };