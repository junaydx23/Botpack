...
api.sendTypingIndicator(event.threadID, true);
  ...
  if (data.length < 2) {
    return api.sendMessage("[ ! ] Input music lyrics title.", event.threadID, event.messageID);
  }
  ...
  try {
    api.sendMessage(`🔎 Searching music lyrics for ${prompt}! Please wait...`, event.threadID, event.messageID);
